...
import { mediaRouter } from "./routers/media.ts";
...
import { platformsRouter } from "./routers/platforms.ts";
import { multiplatformRouter } from "./routers/multiplatform.ts";
import { analyticsRouter } from "./routers/analytics.ts";
import { competitorsRouter } from "./routers/competitors.ts";
import { whatsappRouter } from "./routers/whatsapp.ts";
import { userRouter } from "./routers/user.ts";
import { oauthRouter } from "./routers/oauth.ts";
import { collaborationRouter } from "./routers/collaboration.ts";
import { realTimeAnalyticsRouter } from "./routers/realTimeAnalytics.ts";
import { executionRouter } from "./routers/execution.ts";
...
import { contentAutomationRouter } from "./routers/contentAutomation.ts";
import { billingRouter } from "./routers/billing.ts";
import { captionsRouter } from "./routers/captions.ts";
import { socialConnectionsRouter } from "./routers/socialConnections.ts";
import { postTemplatesRouter } from "./routers/postTemplates.ts";
import { generationHistoryRouter } from "./routers/generationHistory.ts";
import { mercadopagoRouter } from "./routers/mercadopago.ts";
import { adminUsersRouter } from "./routers/adminUsers.ts";
import { subscriptionRouter } from "./routers/subscription.ts";
import { authRouter } from "./routers/auth.ts";
import { imageGenerationRouter } from "./routers/imageGeneration.ts";
import { socialPublishingRouter } from "./routers/socialPublishing.ts";
